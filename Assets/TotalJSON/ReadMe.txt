...
And this can be turned to C# string using CreateString() method like in example above.

Only public fields and fields marked with [SerializeField] are serialized. Constant,
static and readonly fields are not serialized.
...
http://www.leguar.com/unity/totaljson/apidoc/1.5/
